...
% applying ABC scheme on the post-day 12 pattern of the SCC reference 
% dataset.
...
paras_init_d12 = readtable("Round 1 initial parameters.txt");
paras_r2_d12 = readtable("Round 2 parameters.txt");
paras_r3_d12 = readtable("Round 3 parameters.txt");
paras_r4_d12 = readtable("Round 4 parameters.txt");
paras_r5_d12 = readtable("Round 5 parameters.txt");
paras_r6_d12 = readtable("Round 6 parameters.txt");

%% Density plot of dn
dn_init = table2array(paras_init_d12(:,2));
dn_r2 = table2array(paras_r2_d12(:,2));
dn_r3 = table2array(paras_r3_d12(:,2));
dn_r4 = table2array(paras_r4_d12(:,2));
dn_r5 = table2array(paras_r5_d12(:,2));
dn_r6 = table2array(paras_r6_d12(:,2));

[g,xii] = ksdensity(dn_r2,'Bandwidth',0.0004);
[h,xiii] = ksdensity(dn_r3,'Bandwidth',0.0004);
[j,xiv] = ksdensity(dn_r4,'Bandwidth',0.0004);
[z,xv] = ksdensity(dn_r5,'Bandwidth',0.0004);
[m,xvi] = ksdensity(dn_r6,'Bandwidth',0.0004);
...
gamma_init = table2array(paras_init_d12(:,3));
gamma_r2 = table2array(paras_r2_d12(:,3));
gamma_r3 = table2array(paras_r3_d12(:,3));
gamma_r4 = table2array(paras_r4_d12(:,3));
gamma_r5 = table2array(paras_r5_d12(:,3));
gamma_r6 = table2array(paras_r6_d12(:,3));

[g,xii] = ksdensity(gamma_r2,'Bandwidth',0.04);
[h,xiii] = ksdensity(gamma_r3,'Bandwidth',0.04);
[j,xiv] = ksdensity(gamma_r4,'Bandwidth',0.04);
[z,xv] = ksdensity(gamma_r5,'Bandwidth',0.04);
[m,xvi] = ksdensity(gamma_r6,'Bandwidth',0.04);
...
hold off;
lgd = legend({'Initial density($\gamma$)','Post-round 1 density($\gamma$)','Post-round 2 density($\gamma$)','Post-round 3 density($\gamma$)','Post-round 4 density($\gamma$)', 'Post-round 5 density($\gamma$)'},'Interpreter','latex','Location','southwest','Orientation','vertical','Fontsize',10);
xlabel('$\gamma$ values')
ylabel('Probability density')

%% Density plot of rn
rn_init = table2array(paras_init_d12(:,4));
rn_r2 = table2array(paras_r2_d12(:,4));
rn_r3 = table2array(paras_r3_d12(:,4));
rn_r4 = table2array(paras_r4_d12(:,4));
rn_r5 = table2array(paras_r5_d12(:,4));
rn_r6 = table2array(paras_r6_d12(:,4));

[g,xii] = ksdensity(rn_r2,'Bandwidth',0.012);
[h,xiii] = ksdensity(rn_r3,'Bandwidth',0.012);
[j,xiv] = ksdensity(rn_r4,'Bandwidth',0.012);
[z,xv] = ksdensity(rn_r5,'Bandwidth',0.012);
[m,xvi] = ksdensity(rn_r6,'Bandwidth',0.012);
...
eta_init = table2array(paras_init_d12(:,5));
eta_r2 = table2array(paras_r2_d12(:,5));
eta_r3 = table2array(paras_r3_d12(:,5));
eta_r4 = table2array(paras_r4_d12(:,5));
eta_r5 = table2array(paras_r5_d12(:,5));
eta_r6 = table2array(paras_r6_d12(:,5));
...
hold off;
lgd = legend({'Initial density($\eta$)','Post-round 1 density($\eta$)','Post-round 2 density($\eta$)','Post-round 3 density($\eta$)','Post-round 4 density($\eta$)', 'Post-round 5 density($\eta$)'},'Interpreter','latex','Location','southwest','Orientation','vertical','Fontsize',10);
xlabel('$\eta$ values')
ylabel('Probability density')

%% Density plots of dm
dm_init = table2array(paras_init_d12(:,6));
dm_r2 = table2array(paras_r2_d12(:,6));
dm_r3 = table2array(paras_r3_d12(:,6));
dm_r4 = table2array(paras_r4_d12(:,6));
dm_r5 = table2array(paras_r5_d12(:,6));
dm_r6 = table2array(paras_r6_d12(:,6));
...
hold off;
lgd = legend({'Initial density($d_{m}$)','Post-round 1 density($d_{m}$)','Post-round 2 density($d_{m}$)','Post-round 3 density($d_{m}$)','Post-round 4 density($d_{m}$)', 'Post-round 5 density($d_{m}$)'},'Interpreter','latex','Location','southwest','Orientation','vertical','Fontsize',10);
xlabel('$d_{m}$ values')
ylabel('Probability density')

%% Density plots of alpha
alpha_init = table2array(paras_init_d12(:,7));
alpha_r2 = table2array(paras_r2_d12(:,7));
alpha_r3 = table2array(paras_r3_d12(:,7));
alpha_r4 = table2array(paras_r4_d12(:,7));
alpha_r5 = table2array(paras_r5_d12(:,7));
alpha_r6 = table2array(paras_r6_d12(:,7));
...
[m,xvi] = ksdensity(alpha_r6,'Bandwidth',0.01);
...
p_ext_init = table2array(paras_init_d12(:,8));
p_ext_r2 = table2array(paras_r2_d12(:,8));
p_ext_r3 = table2array(paras_r3_d12(:,8));
p_ext_r4 = table2array(paras_r4_d12(:,8));
p_ext_r5 = table2array(paras_r5_d12(:,8));
p_ext_r6 = table2array(paras_r6_d12(:,8));
...
p_mit_init = table2array(paras_init_d12(:,9));
p_mit_r2 = table2array(paras_r2_d12(:,9));
p_mit_r3 = table2array(paras_r3_d12(:,9));
p_mit_r4 = table2array(paras_r4_d12(:,9));
p_mit_r5 = table2array(paras_r5_d12(:,9));
p_mit_r6 = table2array(paras_r6_d12(:,9));
...
hold off;
lgd = legend({'Initial density($P_{mit.}$)','Post-round 1 density($P_{mit.}$)','Post-round 2 density($P_{mit.}$)','Post-round 3 density($P_{mit.}$)','Post-round 4 density($P_{mit.}$)', 'Post-round 5 density($P_{mit.}$)'},'Interpreter','latex','Location','northwest','Orientation','vertical','Fontsize',8);
