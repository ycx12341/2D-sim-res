...
# output for run 1 of post-day 9 SCC pattern. 
...
mean(ls.r6.no.nan[,2]) # 0.5679388
# minimum : 3675th 0.2861427 
...
sse.t9.r6.mean.grid <- paras.r6.mean.res$ind.position.d9
cell.coord <- which(sse.t9.r6.mean.grid == 1, arr.ind = TRUE)
