...
init.cells.cols <- runif(n.sims, 1, 5)
...
# 780.51 sec elapsed. (1st - 10000th)
...
mean(ls.r1.no.nan[,2]) # 7.944395
# minimum : 3111th 0.8559712 
...
# than 2500 in the current round, we chose the desirable ESS to be 
# approximately half of the number of valid output. 
info.list.r1 <- calculate.bw(ss.mat = ls.r1, lb.bw = 0, ub.bw = 2, 
                             ess.target = 722, step.size = 0.01)
