...
# output for run 1 of post-day 3 SCC pattern. 
...
ls.r11 <- vector()
for (i in 1:n.sims) {
  res.temp <- read_rds(paste0("./", save.sims.dir, "/Round_11_paras",i,"_res.rds"))
...
mean(ls.r11.no.nan[,2]) # 0.2106556
# minimum : 8096th 0.05995539
