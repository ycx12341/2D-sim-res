...
# of the post-day 9 SCC invasion patterns. 

# Read in the cell densities at day 9. 
library(readr)
# t6 reference density 
...
# Initial condition (final simulation output of post-day 6 pattern)
res.d6 <- read_rds("Initial condition day 9 simulation full.rds")
n.den.d6 <- res.d6$n.den.d6
f.den.d6 <- res.d6$f.den.d6
m.den.d6 <- res.d6$m.den.d6
ind.position.d6 <- res.d6$ind.position.d6
...
generate.pattern <- function(par, prob.death, prob.prof) {
  ...
  ind.cell <- which(ind.position.d6 == 1, arr.ind = TRUE)
  x.coord <- ind.cell[, 1]
  y.coord <- ind.cell[, 2]
  ind.position <- ind.position.d6
  ...
  return(list(den.mat.d9 = density.mat.d9, ind.position.d9 = ind.position.d9,
              n.den.d9 = n.day9,
              f.den.d9 = f.day9, 
              m.den.d9 = m.day9
  ))
...
calculate.sse <- function(pars, prob.death, prob.prof) {
  ...
  if (is.na(temp.den.table)) {
    ...
    sse.t9 <- sum((temp.den.table$den.mat.d9 - t9.ref.den)^2)
    # Output. 
    return(list(diff = sse.t9,
                den.mat.d9 = temp.den.table$den.mat.d9, 
                ind.position.d9 = temp.den.table$ind.position.d9,
                n.den.d9 = temp.den.table$n.den.d9,
                f.den.d9 = temp.den.table$f.den.d9, 
                m.den.d9 = temp.den.table$m.den.d9
                ))
  }
}
