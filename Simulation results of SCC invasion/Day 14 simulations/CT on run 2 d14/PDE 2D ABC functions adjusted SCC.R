...
# of the post-day 14 SCC invasion patterns. 

# Read in the cell densities at day 14. 
library(readr)
# t14 reference density 
...
# Initial condition (final simulation output of post-day 12 pattern)
res.d12 <- read_rds("Initial condition day 14 simulation full.rds")
n.den.d12 <- res.d12$n.den.d12
f.den.d12 <- res.d12$f.den.d12
m.den.d12 <- res.d12$m.den.d12
ind.position.d12 <- res.d12$ind.position.d12
...
generate.pattern <- function(par, prob.death, prob.prof) {
  ...
  ind.cell <- which(ind.position.d12 == 1, arr.ind = TRUE)
  x.coord <- ind.cell[, 1]
  y.coord <- ind.cell[, 2]
  ind.position <- ind.position.d12
  ...
  return(list(den.mat.d14 = density.mat.d14, ind.position.d14 = ind.position.d14,
              n.den.d14 = n.day14,
              f.den.d14 = f.day14, 
              m.den.d14 = m.day14
  ))
...
calculate.sse <- function(pars, prob.death, prob.prof) {
  ...
  if (is.na(temp.den.table)) {
    ...
    sse.t14 <- sum((temp.den.table$den.mat.d14 - t14.ref.den)^2)
    
    return(list(diff = sse.t14,
                den.mat.d14 = temp.den.table$den.mat.d14, 
                ind.position.d14 = temp.den.table$ind.position.d14,
                n.den.d14 = temp.den.table$n.den.d14,
                f.den.d14 = temp.den.table$f.den.d14, 
                m.den.d14 = temp.den.table$m.den.d14
                ))
  }
}
