...
paras.run2.mean <- rbind(paras.r1.run2.mean, paras.r2.run2.mean, 
                         paras.r3.run2.mean, paras.r4.run2.mean, 
                         paras.r5.run2.mean, paras.r6.run2.mean)
