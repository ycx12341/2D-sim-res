# Run 2 posterior summary.R
# This .R file reads in the related information of the least square differences
# obtained at the end of each round in run 2, extracts the actual ESS and 
# corresponding bandwidth factors and combine them into a matrix. Additionally, 
# the grey shades density plot of the final output in run 2 is generated in 
# this file. 
...
ess.vec <- c(info.list.r1$ess.obj, info.list.r2$ess.obj, 
             ...
             info.list.r9$ess.obj, info.list.r10$ess.obj)
bw.vec <- c(info.list.r1$bw.obj, info.list.r2$bw.obj, 
            ...
            info.list.r9$bw.obj, info.list.r10$bw.obj)
