...
% applying ABC scheme on the post-day 9 pattern of the SCC reference 
% dataset.
...
paras_init_d9 = readtable("Round 1 initial parameters.txt");
paras_r2_d9 = readtable("Round 2 parameters.txt");
paras_r3_d9 = readtable("Round 3 parameters.txt");
paras_r4_d9 = readtable("Round 4 parameters.txt");
paras_r5_d9 = readtable("Round 5 parameters.txt");
paras_r6_d9 = readtable("Round 6 parameters.txt");

%% Density plot of dn
dn_init = table2array(paras_init_d9(:,2));
dn_r2 = table2array(paras_r2_d9(:,2));
dn_r3 = table2array(paras_r3_d9(:,2));
dn_r4 = table2array(paras_r4_d9(:,2));
dn_r5 = table2array(paras_r5_d9(:,2));
dn_r6 = table2array(paras_r6_d9(:,2));
...
gamma_init = table2array(paras_init_d9(:,3));
gamma_r2 = table2array(paras_r2_d9(:,3));
gamma_r3 = table2array(paras_r3_d9(:,3));
gamma_r4 = table2array(paras_r4_d9(:,3));
gamma_r5 = table2array(paras_r5_d9(:,3));
gamma_r6 = table2array(paras_r6_d9(:,3));
...
%% Density plot of rn
rn_init = table2array(paras_init_d9(:,4));
rn_r2 = table2array(paras_r2_d9(:,4));
rn_r3 = table2array(paras_r3_d9(:,4));
rn_r4 = table2array(paras_r4_d9(:,4));
rn_r5 = table2array(paras_r5_d9(:,4));
rn_r6 = table2array(paras_r6_d9(:,4));

[g,xii] = ksdensity(rn_r2,'Bandwidth',0.015);
[h,xiii] = ksdensity(rn_r3,'Bandwidth',0.015);
[j,xiv] = ksdensity(rn_r4,'Bandwidth',0.015);
[z,xv] = ksdensity(rn_r5,'Bandwidth',0.015);
[m,xvi] = ksdensity(rn_r6,'Bandwidth',0.015);
...
eta_init = table2array(paras_init_d9(:,5));
eta_r2 = table2array(paras_r2_d9(:,5));
eta_r3 = table2array(paras_r3_d9(:,5));
eta_r4 = table2array(paras_r4_d9(:,5));
eta_r5 = table2array(paras_r5_d9(:,5));
eta_r6 = table2array(paras_r6_d9(:,5));
...
%% Density plots of dm
dm_init = table2array(paras_init_d9(:,6));
dm_r2 = table2array(paras_r2_d9(:,6));
dm_r3 = table2array(paras_r3_d9(:,6));
dm_r4 = table2array(paras_r4_d9(:,6));
dm_r5 = table2array(paras_r5_d9(:,6));
dm_r6 = table2array(paras_r6_d9(:,6));
...
alpha_init = table2array(paras_init_d9(:,7));
alpha_r2 = table2array(paras_r2_d9(:,7));
alpha_r3 = table2array(paras_r3_d9(:,7));
alpha_r4 = table2array(paras_r4_d9(:,7));
alpha_r5 = table2array(paras_r5_d9(:,7));
alpha_r6 = table2array(paras_r6_d9(:,7));

[g,xii] = ksdensity(alpha_r2,'Bandwidth',0.012);
[h,xiii] = ksdensity(alpha_r3,'Bandwidth',0.012);
[j,xiv] = ksdensity(alpha_r4,'Bandwidth',0.012);
[z,xv] = ksdensity(alpha_r5,'Bandwidth',0.012);
[m,xvi] = ksdensity(alpha_r6,'Bandwidth',0.012);
...
p_ext_init = table2array(paras_init_d9(:,8));
p_ext_r2 = table2array(paras_r2_d9(:,8));
p_ext_r3 = table2array(paras_r3_d9(:,8));
p_ext_r4 = table2array(paras_r4_d9(:,8));
p_ext_r5 = table2array(paras_r5_d9(:,8));
p_ext_r6 = table2array(paras_r6_d9(:,8));
...
p_mit_init = table2array(paras_init_d9(:,9));
p_mit_r2 = table2array(paras_r2_d9(:,9));
p_mit_r3 = table2array(paras_r3_d9(:,9));
p_mit_r4 = table2array(paras_r4_d9(:,9));
p_mit_r5 = table2array(paras_r5_d9(:,9));
p_mit_r6 = table2array(paras_r6_d9(:,9));

[g,xii] = ksdensity(p_mit_r2,'Bandwidth',0.06);
[h,xiii] = ksdensity(p_mit_r3,'Bandwidth',0.06);
[j,xiv] = ksdensity(p_mit_r4,'Bandwidth',0.06);
[z,xv] = ksdensity(p_mit_r5,'Bandwidth',0.06);
[m,xvi] = ksdensity(p_mit_r6,'Bandwidth',0.06);
