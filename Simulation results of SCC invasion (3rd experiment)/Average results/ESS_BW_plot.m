...
% round of the simulations in the case study on SCC invasion patterns with
...
figure
title({'Variation of actual ESS', '(time-varying SCC)'})
hold on;
...
figure
title({'Variation of bandwidth', '(time-varying SCC)'})
hold on;
