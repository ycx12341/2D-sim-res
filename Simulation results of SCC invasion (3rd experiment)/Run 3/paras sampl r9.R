...
mean(ls.r9.no.nan[,2]) # 4.224354
# minimum : 15251th 2.625072
...
paras.r9.mean <- apply(paras.r9, 2, mean)

# Generate the final simulation output. 
set.seed(874514) 
RNGkind(sample.kind = "Rejection")
paras.r9.mean.res <- generate.pattern(par = paras.r9.mean[1:6], 
                                       init.cells.cols = paras.r9.mean[7],
                                       prob.death = paras.r9.mean[8], 
                                       prob.prof = paras.r9.mean[9],
                                       slopes = paras.r9.mean[10:21])

# Write the final output into an .rds file. 
write_rds(paras.r9.mean.res, "paras r9 average result.rds")
paras.r9.mean.res <- read_rds("paras r9 average result.rds")

# Plot of individual cell positions. 
sse.t3.r9.mean.grid <- paras.r9.mean.res$ind.position.d14
cell.coord <- which(sse.t3.r9.mean.grid == 1, arr.ind = TRUE)
...
den.mat.d3 <- paras.r9.mean.res$den.mat.d3
den.mat.d6 <- paras.r9.mean.res$den.mat.d6
den.mat.d9 <- paras.r9.mean.res$den.mat.d9
den.mat.d12 <- paras.r9.mean.res$den.mat.d12
den.mat.d14 <- paras.r9.mean.res$den.mat.d14
