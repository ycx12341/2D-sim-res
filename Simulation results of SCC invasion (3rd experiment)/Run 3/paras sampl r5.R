# paras sampl r5.R
# Author: Yunchen Xiao
# This .R file reads in the post-round 4 parameters to be evaluated for the 
...
paras.r5 <- as.matrix(read.table("Round 5 parameters.txt", 
                                 sep = "", header = TRUE))
...
mean(ls.r5.no.nan[,2]) # 6.255717
# minimum : 18151th 3.049216
...
info.list.r5 <- calculate.bw(ss.mat = ls.r5, lb.bw = 7.41, ub.bw = 7.51, 
                             ess.target = 9112.5, step.size = 0.01)
