...
paras_r2 = readtable("Round 2 parameters.txt");
paras_r3 = readtable("Round 3 parameters.txt");
paras_r4 = readtable("Round 4 parameters.txt");
paras_r5 = readtable("Round 5 parameters.txt");
paras_r6 = readtable("Round 6 parameters.txt");
paras_r7 = readtable("Round 7 parameters.txt");
...
[k,xvii] = ksdensity(dn_r7,'Bandwidth',0.00001);
...
plot(xvii,k, '-','Color',[0.4940 0.1840 0.5560])
...
plot(mean(dn_r7),0,'x','Color',[0.4940 0.1840 0.5560],'markersize',20)
hold off;
lgd = legend({'Initial density($d_{n}$)','Post-round 1 density($d_{n}$)','Post-round 2 density($d_{n}$)','Post-round 3 density($d_{n}$)','Post-round 4 density($d_{n}$)', 'Post-round 5 density($d_{n}$)', 'Post-round 6 density($d_{n}$)'},'Interpreter','latex','Location','northeast','Orientation','vertical','Fontsize',12);
xlabel('$d_{n}$ values')
...
plot(xvii,k, 'k-')
plot(mean(dn_init),0,'xb','markersize',20)
plot(mean(dn_r7),0,'xk','markersize',20)
hold off;
...
[k,xvii] = ksdensity(rn_r7,'Bandwidth',0.0006);
...
plot(mean(rn_r7),0,'x','Color',[0.4940 0.1840 0.5560],'markersize',20)
hold off;
lgd = legend({'Initial density($r_{n}$)','Post-round 1 density($r_{n}$)','Post-round 2 density($r_{n}$)','Post-round 3 density($r_{n}$)','Post-round 4 density($r_{n}$)', 'Post-round 5 density($r_{n}$)','Post-round 6 density($r_{n}$)'},'Interpreter','latex','Location','southwest','Orientation','vertical','Fontsize',10);
xlabel('$r_{n}$ values')
ylabel('Probability density')
...
plot(xvii,k, 'k-')
plot(mean(rn_init),0,'xb','markersize',20)
plot(mean(rn_r7),0,'xk','markersize',20)
hold off;
lgd = legend({'Initial density($r_{n}$)','Post-round 6 density($r_{n}$)'},'Interpreter','latex','Location','southwest','Orientation','vertical','Fontsize',10);
xlabel('$r_{n}$ values')
ylabel('Probability density')
...
r_init_r7 = table2array(paras_r7(:,4));
...
[k,xvii] = ksdensity(r_init_r7,'Bandwidth',0.008);
...
plot(mean(r_init_r7),0,'x','Color',[0.4940 0.1840 0.5560],'markersize',20)
hold off;
lgd = legend({'Initial density($R_{init.}$)','Post-round 1 density($R_{init.}$)','Post-round 2 density($R_{init.}$)','Post-round 3 density($R_{init.}$)','Post-round 4 density($R_{init.}$)', 'Post-round 5 density($R_{init.}$)','Post-round 6 density($R_{init.}$)'},'Interpreter','latex','Location','northwest','Orientation','vertical','Fontsize',10);
...
plot(xvii,k, 'k-')
plot(mean(r_init_init),0,'xb','markersize',20)
plot(mean(r_init_r7),0,'xk','markersize',20)
hold off;
...
p_ext_r7 = table2array(paras_r7(:,5));
...
[k,xvii] = ksdensity(p_ext_r7,'Bandwidth',0.013);
...
plot(mean(p_ext_r7),0,'x','Color',[0.4940 0.1840 0.5560],'markersize',20)
hold off;
lgd = legend({'Initial density($P_{ext.}$)','Post-round 1 density($P_{ext.}$)','Post-round 2 density($P_{ext.}$)','Post-round 3 density($P_{ext.}$)','Post-round 4 density($P_{ext.}$)', 'Post-round 5 density($P_{ext.}$)','Post-round 6 density($P_{ext.}$)'},'Interpreter','latex','Location','southwest','Orientation','vertical','Fontsize',10);
...
plot(xvii,k, 'k-')
plot(mean(p_ext_init),0,'xb','markersize',20)
plot(mean(p_ext_r7),0,'xk','markersize',20)
hold off;
lgd = legend({'Initial density($P_{ext.}$)','Post-round 6 density($P_{ext.}$)'},'Interpreter','latex','Location','southwest','Orientation','vertical','Fontsize',10);
xlabel('$P_{ext.}$ values')
ylabel('Probability density')
...
p_mit_r7 = table2array(paras_r7(:,6));
...
[k,xvii] = ksdensity(p_mit_r7,'Bandwidth',0.07);
...
plot(mean(p_mit_r7),0,'x','Color',[0.4940 0.1840 0.5560],'markersize',20)
hold off;
lgd = legend({'Initial density($P_{mit.}$)','Post-round 1 density($P_{mit.}$)','Post-round 2 density($P_{mit.}$)','Post-round 3 density($P_{mit.}$)','Post-round 4 density($P_{mit.}$)', 'Post-round 5 density($P_{mit.}$)','Post-round 6 density($P_{mit.}$)'},'Interpreter','latex','Location','northeast','Orientation','vertical','Fontsize',10);
...
plot(xvii,k, 'k-')
plot(mean(p_mit_init),0,'xb','markersize',20)
plot(mean(p_mit_r7),0,'xk','markersize',20)
hold off;
lgd = legend({'Initial density($P_{mit.}$)','Post-round 6 density($P_{mit.}$)'},'Interpreter','latex','Location','northeast','Orientation','vertical','Fontsize',10);
xlabel('$P_{mit.}$ values')
ylabel('Probability density')