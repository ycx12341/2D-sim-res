...
# distance (multivariate version) with the reference data. The final output 
# which yields the minimum B-C distance was chosen as the final result of the 
# post-day 14 SCC pattern's simulation. In addition, the plots of actual ESS 
# and bandwidth factors at the end of different rounds are generated 
# in this file. 
