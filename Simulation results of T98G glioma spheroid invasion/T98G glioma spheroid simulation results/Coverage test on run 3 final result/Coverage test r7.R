...
# write.table(cov.mat, 
# "Coverage probabilities glioma r7 d1 d3 
# perturbed separately non zero only.txt")
write.table(cov.mat, 
            "Coverage probabilities glioma r7 d1 d3 perturbed separately.txt")

# cov.mat <- read.table("Coverage probabilities glioma r7 
# d1 d3 perturbed separately non zero only.txt", sep = "", header = TRUE)
...
# 4/5 parameters passed the coverage test! 
