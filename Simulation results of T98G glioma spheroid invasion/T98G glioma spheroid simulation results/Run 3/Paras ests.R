...
paras.init.run3 <- read.table("Round 1 initial parameters.txt", sep = "", 
                         header = TRUE)
paras.r2.run3 <- read.table("Round 2 parameters.txt", sep = "", 
                         header = TRUE)
paras.r3.run3 <- read.table("Round 3 parameters.txt", sep = "", 
                         header = TRUE)
paras.r4.run3 <- read.table("Round 4 parameters.txt", sep = "", 
                         header = TRUE)
paras.r5.run3 <- read.table("Round 5 parameters.txt", sep = "", 
                         header = TRUE)
paras.r6.run3 <- read.table("Round 6 parameters.txt", sep = "", 
                         header = TRUE)
paras.r7.run3 <- read.table("Round 7 parameters.txt", sep = "", 
                         header = TRUE)
...
paras.r7.mean <- apply(paras.r7.run3, 2, mean)
