...
# 0, all output from the final parameter sample are valid. 
...
write_rds(paras.r7.output, "Full output paras r7 run 1.rds")
...
ls.r7.min <- read_rds("Round_7_paras307_res.rds")
