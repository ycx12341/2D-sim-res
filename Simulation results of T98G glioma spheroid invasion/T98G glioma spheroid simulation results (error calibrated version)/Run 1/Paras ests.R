...
paras.init.run1 <- read.table("Round 1 initial parameters.txt", sep = "", 
                         header = TRUE)
paras.r2.run1 <- read.table("Round 2 parameters log transform.txt", sep = "", 
                         header = TRUE)
paras.r3.run1 <- read.table("Round 3 parameters log transform.txt", sep = "", 
                         header = TRUE)
paras.r4.run1 <- read.table("Round 4 parameters log transform.txt", sep = "", 
                         header = TRUE)
paras.r5.run1 <- read.table("Round 5 parameters log transform.txt", sep = "", 
                         header = TRUE)
paras.r6.run1 <- read.table("Round 6 parameters log transform.txt", sep = "", 
                         header = TRUE)
