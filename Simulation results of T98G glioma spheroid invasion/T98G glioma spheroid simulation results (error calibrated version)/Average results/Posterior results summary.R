...
paras.r6.run1 <- as.matrix(read.table("Round 6 parameters log transform run 1.txt", sep = "", 
                                      header = TRUE))
paras.r6.run2 <- as.matrix(read.table("Round 6 parameters log transform run 2.txt", sep = "", 
                                      header = TRUE))
paras.r6.run3 <- as.matrix(read.table("Round 6 parameters log transform run 3.txt", sep = "", 
                                      header = TRUE))
...
points(x = seq(1,5,by = 1), y = ess.bw.run2[,2], pch = 2, lwd = 2, 
       col = "red")
